...
public class ItemPostReturnModel {
  ...
  private ItemPostReturnModelResult result;

  public ItemPostReturnModel ok(Boolean ok) {
    this.ok = ok;
    return this;
  }
  ...
  public ItemPostReturnModel result(ItemPostReturnModelResult result) {
    this.result = result;
    return this;
  }
  ...
  public void setResult(ItemPostReturnModelResult result) {
    this.result = result;
  }
  ...
  public String toString() {
    ...
    sb.append("class ItemPostReturnModel {\n");
